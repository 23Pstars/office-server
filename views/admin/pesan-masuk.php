...
Headers::get_instance()
    ->set_page_title( 'Pesan Masuk' )
    ->set_page_name( 'Pesan Masuk' );
    ...
    <div class="row">
        ...
        <div class="col-xs-9 col-sm-10 main">
            <?php if( $is_lihat ) :
                ...
                if( $obj_pesan->hasProcessedFalse() ) Inbox::get_instance()->set_processed( $obj_pesan->getID(), Inbox::processed_true ); ?>
                ...
                <table class="table table-bordered table-striped">
                    ...
                    foreach( $daftar_pesan as $pesan ) : ?>
                        <tr <?php if( $pesan->hasProcessedFalse() ) : ?>class="success"<?php endif; ?>>
                            ...
                            <td><?php echo $pesan->getAppendedTextDecoded( 40 ); ?></td>
                            <td>
